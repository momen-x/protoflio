...
const translations = {
  en: {
    ...
    "about.story":
      "I'm a front-end developer passionate about web development. My journey began with learning Java at university, which was later interrupted by difficult circumstances (the war in Gaza). However, I returned with renewed enthusiasm. I started by reviewing the fundamentals of programming in languages ​​like C, C++, PHP, and Python, but I quickly discovered my true passion in HTML, CSS, and JavaScript for user interface development. I learned frameworks like Bootstrap and Tailwind CSS and built several projects as practical applications. After that, I delved deeper into React JS to build more professional websites, using external libraries. Currently, I'm building complete websites ( full stack ) using Nextjs. I'm always striving to improve my skills and stay up-to-date with the latest technologies in the field.",
  ...
  ar: {
    ...
    "hero.cv": "CV قم بتنزيل ال ",
    "about.intro": "مقدمة",
    "about.overview": "نظرة عامة",
    "about.story":
      "أنا مبرمج واجهة أمامية (Front-end Developer) شغوف بتطوير مواقع الويب. بدأت رحلتي في عالم البرمجة بتعلم Java في الجامعة، ثم توقفت بسبب الظروف الصعبة (الحرب على غزة و فقدان الاتصال بالنترنت)، ولكنني عدت بشغف أكبر. بدأت بمراجعة أساسيات البرمجة في لغات مثل C, C++, PHP, و Python، ولكن سرعان ما وجدت شغفي الحقيقي في HTML, CSS, و JavaScript لتطوير واجهات المستخدم.",
